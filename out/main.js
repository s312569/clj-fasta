...
g.add=function(a){for(var c=Math.max(this.a.length,a.a.length),d=[],b=0,e=0;e<=c;e++){var f=b+(v(this,e)&65535)+(v(a,e)&65535),h=(f>>>16)+(v(this,e)>>>16)+(v(a,e)>>>16),b=h>>>16,f=f&65535,h=h&65535;d[e]=h<<16|f}return new k(d,d[d.length-1]&-2147483648?-1:0)};g.j=function(a){return this.add(a.b())};
